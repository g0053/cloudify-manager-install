...
cp ${RPM_SOURCE_DIR}/packaging/etc %{buildroot}/etc -fr
cp ${RPM_SOURCE_DIR}/packaging/cloudify %{buildroot}/opt/cloudify -fr
cp ${RPM_SOURCE_DIR}/packaging/cfy_manager %{buildroot}/usr/bin/cfy_manager
